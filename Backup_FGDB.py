...
def main():
    ...
    #---------------------------------------------------------------------------
    # Set paths
    FGDB_to_backup = r"P:\DPW_ScienceAndMonitoring\Scripts\PROD\Data\DPW_Science_and_Monitoring_prod.gdb"
    backup_folder  = r'P:\DPW_ScienceAndMonitoring\Scripts\PROD\Data\Backups'
    log_file        = r'P:\DPW_ScienceAndMonitoring\Scripts\PROD\Data\Logs\Backup_FGDB'
