...
def main():
    ...
    # Name of this script
    name_of_script = 'Download_Sci_and_Mon_Attachments.py'
    ...
    # For example 'DA_Fire'
    attachment_name_prefix = 'Sci_and_Mon'
    ...
    use_field_to_name_attachment = 'SampleEventID'
...
##        path_prefix = 'P:'
    ...
    cfgFile     = r"H:\Projects\DPW_Sci_and_Mon\Config_Files\Config_File.ini"
